...
<body>
    ...
    <section id="contenedor">
        ...
        <div class="search-box">
            ...
            <input type="text" class="input-search" placeholder="Buscar..." name="busqueda" id="busqueda" value="<?php echo $busqueda; ?>">
        </div>
        </form>
        ...
        <table>
            ...
            //Paginador
            $sql_registe = mysqli_query($conexion, "SELECT COUNT(*) as total_registros FROM usuarios WHERE
                                                                                                        idusuario LIKE '%$busqueda%' OR
                                                                                                        nombrecompleto LIKE '%$busqueda%' OR
                                                                                                        usuario LIKE '%$busqueda%' OR
                                                                                                        correo LIKE '%$busqueda%' OR
                                                                                                        perfil LIKE '%$busqueda%'
                                                                                                        ");
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="editarU.php?id=<?php echo $data['idusuario']; ?>"><button class="link_edit"><i class="fa-solid fa-pen"></i></button></a>

                    <a href="borrar.php?id=<?php echo $data['idusuario']; ?>"><button class="link_delete"><i class="fa-solid fa-x"></i></button></a>
                </td>
            </tr>
