...
<body>
    ...
    <section id="contenedor">
        ...
        <a href="AgregarGuia.php" class="btn_new">Crear Guia</a>

        <!-- Buscador-->

        <form action="controlador/gestiontablaG/buscarG.php#contenedor" method="GET" class="form_search">
        ...
        <table>
            ...
            //Paginador
            $sql_registe = mysqli_query($conexion, "SELECT COUNT(*) as total_registros FROM guias");
            ...
            //Consulta
            $query = mysqli_query($conexion,"SELECT g.idguia, g.titulo, g.sinopsis, g.contenido, g.fotoportada, u.nombrecompleto FROM guias g INNER JOIN usuarios u ON g.idusuario = u.idusuario LIMIT $desde,$por_pagina;
            ");
            ...
            <tr>
                ...
                <td class="camposinopsis"><?php echo $data['sinopsis']; ?></td>
